...
const Projects = () => {
    return (
        <section id='projects' className='body-font animate__animated animate__fadeInUp'>
                ...
                <div className='flex flex-wrap -m-4 rounded'>
                    {projects.map((project, index) => (
                        <a
                            href={project.link}
                            key={project.image}
                            className={index % 2 === 0 ? 'sm:w-1/2 w-100 p-4 animate__animated animate__fadeInLeft rounded' : 'sm:w-1/2 w-100 p-4 animate__animated animate__fadeInRight rounded'}>
