      ...
      <div className='container mx-auto flex px-10 py-20 md:flex-row flex-col items-center'>
        <div className='lg:flex-grow md:w-2/3 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center animate__animated animate__fadeInLeft'>
          ...
          <div className='flex justify-center items-center'>
            ...
            <a
              href='#projects'
              className='ml-4 inline-flex bg-gray-200 dark:bg-gray-900 border border-gray-500 py-2 px-6 focus:outline-none hover:text-white hover:bg-gray-600 dark:hover:bg-gray-600 rounded text-lg '
            >
